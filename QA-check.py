...
class DashboardUI:
    ...
    def _build(self):
        ...
        tk.Checkbutton(frame, text="Enable Debug Logs", variable=self.debug_enabled).grid(
        ...
        range_menu = tk.OptionMenu(
            ...
            "Last 6 Months",
            "Custom Range",
            command=lambda _: self._toggle_custom_dates(),
        )
    ...
    def _load_daily_counts_for_aaid(self, aaid: str) -> None:
        ...
        for date_key in sorted_dates:
            ...
            row_text = f"{date_key} | Start: {counts.start_count} | Stop: {counts.stop_count} | {status}"
    ...
    def _refresh_worker(self):
        try:
            ...
            try:
                ...
                self._log_debug(f"Reading Outlook folder: {folder_path}")
